...
For dimensions that should blend across tables in queries, set the same `extended_blend_group` on each. See [Extended blending groups](/docs/semantic-model/extended-blending-groups/).
