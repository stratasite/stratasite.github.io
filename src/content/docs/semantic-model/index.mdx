...
The **Advanced** subsection below covers deeper and optional semantic-model features: exclusions, inclusions, decorators, semantic routing, and cost optimization. The core basics (tables, fields, expressions, relationships, imports) are above; Advanced is for more in-depth and extra scenarios.
